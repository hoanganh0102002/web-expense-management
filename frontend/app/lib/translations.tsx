...
const translations: Record<string, Record<string, string>> = {
  vi: {
    ...
    daily_spending_trend: "Biến động số dư & Thu chi",
    balance_trend: "Biến động số dư lũy kế",
    ...
    delete_confirm_2: "XÁC NHẬN LẦN CUỐI: Bạn thực sự muốn xóa vĩnh viễn tài khoản EM chứ?",
    ...
    google_auth_error: "Lỗi xác thực Google: ",
    loading_login_page: "Đang tải trang đăng nhập...",
    register_title: "Tham gia EM ngay",
    register_subtitle: "Bắt đầu hành trình quản lý tài chính thông minh",
    register_subtitle_detail: "Tham gia EM ngay hôm nay. Chỉ mất một phút!",
    ...
    no_transactions_found_budget: "Không có giao dịch nào trong danh mục này.",
    ...
    setup_budget_limit: "Thiết lập hạn mức ngân sách",
    edit_budget_limit: "Chỉnh sửa hạn mức ngân sách",
    apply_to_category: "Áp dụng cho danh mục",
    overall_budget_option: "Ngân sách chung",
    by_category: "Theo danh mục",
    limit_amount_label: "Số tiền hạn mức",
    ...
    compare_spending_with_last_month: "So sánh chi tiêu với tháng trước",
    spending_this_month: "Chi tiêu tháng này",
    increased: "tăng",
    decreased: "giảm",
    compared_to_last_month: "so với tháng trước",
    spending_equal_last_month: "Chi tiêu tháng này tương đương với tháng trước.",
    prev_month_limit: "Hạn mức tháng trước",
    curr_month_limit: "Hạn mức tháng này",
    no_comparison_data: "Chưa có dữ liệu so sánh",
    no_comparison_data_desc: "Biểu đồ so sánh chi tiêu với tháng trước sẽ hiển thị ở đây khi bạn bắt đầu ghi chép giao dịch trong tháng tiếp theo!",
    view_details: "Xem chi tiết",
    close_details: "Đóng chi tiết",
    onboard_step1_title: "Đặt mục tiêu tổng",
    onboard_step1_desc: "Đặt ngân sách tổng cho cả tháng để giới hạn tổng chi tiêu của bạn.",
    onboard_step2_title: "Chia nhỏ danh mục",
    onboard_step2_desc: "Phân bổ ngân sách riêng cho các nhóm như Ăn uống, Di chuyển, Mua sắm để dễ quản lý.",
    onboard_step3_title: "Nhận cảnh báo chi tiêu",
    onboard_step3_desc: "Nhận thông báo nhắc nhở tự động khi chi tiêu của bạn chạm mức 80% hoặc vượt quá 100% hạn mức!",
    ...
    // Dashboard Extra
    no_spending_in_period: "Chưa có chi tiêu trong khoảng thời gian này!",
    day_label: "Ngày",
    month_label_prefix: "Tháng",
    hide_balance: "Ẩn số tiền",
  ...
  en: {
    ...
    daily_spending_trend: "Balance & Cash Flow Fluctuations",
    balance_trend: "Cumulative Balance Trend",
    ...
    delete_confirm_2: "FINAL CONFIRMATION: Do you really want to permanently delete your EM account?",
    ...
    register_title: "Join EM Now",
    register_subtitle: "Start your smart financial management journey",
    register_subtitle_detail: "Join EM today. It only takes a minute!",
    ...
    transactions_in_month: "Transactions in month",
    loading_transactions: "Loading transactions...",
    no_transactions_found_budget: "No transactions found in this category.",
    ...
    overall_budget_option: "Overall Budget",
    ...
    compare_spending_with_last_month: "Compare spending with last month",
    ...
    spending_equal_last_month: "Spending this month is similar to last month.",
    prev_month_limit: "Last month's limit",
    curr_month_limit: "This month's limit",
    no_comparison_data: "No comparison data yet",
    no_comparison_data_desc: "The spending comparison chart will appear here once you start recording transactions in the next month!",
    view_details: "View details",
    close_details: "Close details",
    onboard_step1_title: "Set a total goal",
    onboard_step1_desc: "Set a total monthly budget to limit your overall spending.",
    onboard_step2_title: "Split into categories",
    onboard_step2_desc: "Allocate separate budgets for groups like Food, Transport, Shopping for easier management.",
    onboard_step3_title: "Receive spending alerts",
    onboard_step3_desc: "Get automatic notifications when your spending reaches 80% or exceeds 100% of the limit!",
    ...
    // Dashboard Extra
    no_spending_in_period: "No spending in this time period!",
    day_label: "Day",
    month_label_prefix: "Month",
