...
const translations: Record<string, Record<string, string>> = {
  vi: {
    ...
    overall_budget_option: "Ngân sách tổng cả tháng",
    limit_amount_label: "Hạn mức",
    ...
    no_transactions_found_budget: "Không tìm thấy giao dịch nào thuộc ngân sách này",
    no_past_budgets: "Không có dữ liệu ngân sách trong quá khứ",
    food: "Ăn uống",
    transport: "Di chuyển",
    shopping: "Mua sắm",
  ...
  en: {
    ...
    overall_budget_option: "Overall Monthly Budget",
    limit_amount_label: "Limit Amount",
    saving_label: "Saving...",
    save_budget_btn: "Save Budget",
    transactions_in_month: "Transactions in Month",
    loading_transactions: "Loading transactions...",
    no_transactions_found_budget: "No transactions found under this budget",
    no_past_budgets: "No past budget data",
    food: "Food",
    transport: "Transport",
    shopping: "Shopping",
